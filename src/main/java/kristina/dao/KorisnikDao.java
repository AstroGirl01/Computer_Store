...
public class KorisnikDao {
    ...
    public List<Korisnik> getAllKorisnici() throws prodavnica_exception {
        ...
        try (Connection con = ResourcesManager.getConnection(); PreparedStatement ps = con.prepareStatement(sql); ResultSet rs = ps.executeQuery()) {
    ...
    public int insertKorisnik(Korisnik k, Connection con) throws SQLException {
        PreparedStatement ps = null;
        ResultSet rs = null;
        int id = -1;
    ...
    public void updatePodatke(String username, Korisnik noviPodaci, Connection con) throws SQLException {
        PreparedStatement ps = null;
        try {
    ...
    public int deleteByUsername(String username, Connection con) throws SQLException {
    ...
    public void update(Korisnik korisnik, Connection con) throws SQLException {
        ...
        try {
            ...
            ps.setString(4, korisnik.getE_mail());
